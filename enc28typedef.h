...
//-------------------------#define CSACTIVE                                (PORTD = PORTD & 0xEF) // B11111011)
                                                                            // B11111011) //digitalWrite(ENC28J60_CONTROL_CS, LOW)
// set CS to 1 = passive
#define CSPASSIVE                               (PORTB = PORTB | 0x04)
//-------------------------#define CSPASSIVE                               digitalWrite(ENC28J60_CONTROL_CS, HIGH) 
//-------------------------#define CSPASSIVE                               (PORTD = PORTD | 0x10) // B00000100)
                                                                            // B00000100) //digitalWrite(ENC28J60_CONTROL_CS, HIGH) 
//
